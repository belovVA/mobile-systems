    ...
    Scaffold(
        ...
        Surface(
            ...
            when (currentStep) {
                1 -> {
                    LemonTextAndImage(
                        textLabelResourceId = R.string.one_page,
                ...
                2 -> {
                    LemonTextAndImage(
                        textLabelResourceId = R.string.two_page,
                        drawableResourceId = R.drawable.lemon_squeeze,
                        contentDescriptionResourceId = R.string.lemon_name,
                        onImageClick = {
                            squeezeCount--
                            if (squeezeCount == 0) {
                                currentStep = 3
                ...
                3 -> {
                    LemonTextAndImage(
                        textLabelResourceId = R.string.three_page,
                ...
                4 -> {
                    LemonTextAndImage(
                        textLabelResourceId = R.string.four_page,
